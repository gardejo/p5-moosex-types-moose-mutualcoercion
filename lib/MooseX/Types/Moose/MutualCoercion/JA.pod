...
この文書はL<MooseX::Types::Moose::MutualCoercion|MooseX::Types::Moose::MutualCoercion>のバージョンC<0.03>について記述しています。
...
これの代わりに、L<MooseX::Types::LoadableClassのLodableType|
MooseX::Types::LoadableClass/LoadableType>を使ってください。
